...
window.THEMES = [
  ...
  { id:"legitimacy",  label:"Influence, legitimacy & power",   group:"capital", ax:-0.12, r:21,
    ...
    href:"persons.html" },
  { id:"hardmoney",   label:"Real value — wages, assets & hard money", group:"lens", ax:0.10, r:23,
    stat:"a year of work: ~122 -> ~27 oz gold",
    blurb:"The Real-value page: wages, homes and the market repriced in gold- and silver-ounces; who owns the assets that inflated; and a machine-checked proof that labor's claim on the store-of-value economy fell - with the honest boundary where the proof stops, the rent/CPI (ALNRI) lag, and live source data you can export.",
    href:"multidenom.html" },
