...
### 2.1 The graph
Consolidating 20 cited research files into one canonical funding graph (`models/graph/build_graph.py` → `data/graph.json`): **62 nodes, 81 directed money/credit/compute edges.**
