...
### 2.1 The graph
Consolidating 40 cited research files into one canonical funding graph (`models/graph/build_graph.py` → `data/graph.json`): **104 nodes, 127 directed money/credit/compute edges.**
