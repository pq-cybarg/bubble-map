...
## Reproduce
`bash run_all.sh` runs the Z3 engines, TLA+, Alloy, and the graph/bank/temporal/gold/defense/energy/contagion models (38 runnable models). 163 cited research blocks in `research/`.
