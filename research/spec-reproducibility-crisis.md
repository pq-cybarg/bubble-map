...
**The other end of the same stick (2026):** while curl drowned in slop, **Hacktron's HEIF Heist / OpenAI report was real** - libheif RCE on community.openai.com, SSO to employee Codex, proof PR into the internal monorepo, 14-hour patch, $6,500 bounty with the forum marked out of scope. LiveOverflow's 19 Sep 2026 thread is the process layer (antagonistic Slack, then a CISO apology). AI made *fake* reports free **and** made *real* parser-RCE campaigns cheap. See [[spec-heif-heist-openai-ciso]].
