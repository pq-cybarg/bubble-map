...
>
> **Discipline (per #171).** Absence of public disclosure is treated as **absence of evidence, not proof of concealment**; extraordinary claims need primary evidence. Grades: fact | contested | weak | unsupported. Overlay; excluded from the proofs.
...
*Sources: [CoinDesk — Who is Cross River Bank (Mar 2023)](https://www.coindesk.com/business/2023/03/15/who-is-cross-river-bank-usdc-issuer-circles-new-partner); [Cross River — Stablecoin Payments launch (2025)](https://www.crossriver.com/newsroom/cross-river-launches-stablecoin-payments-with-infrastructure-to-power-the-future-of-onchain-finance); [Cross River — Stablecoin Payments product](https://www.crossriver.com/products/stablecoin-payments); [ABA Banking Journal — FDIC consent order (2023)](https://bankingjournal.aba.com/2023/05/cross-river-bank-enters-consent-order-with-fdic-over-fair-lending-compliance-practices/); [Genfinity (secondary/Web3) — the X Money/CRB/Ripple claim (graded unverified)](https://genfinity.io/2026/03/04/x-money-cross-river-bank-solana-ripple-connection/); [Finovate — Visa USDC settlement in the US](https://finovate.com/visa-launches-usdc-settlement-in-the-us/).*
