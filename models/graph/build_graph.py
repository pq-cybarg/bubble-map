...
ALIAS = {
 ...
 # planet labs + commercial space-imaging / EO industry
 "Planet_Labs":"Planet_Labs","PlanetLabs":"Planet_Labs","Planet_Labs_PBC":"Planet_Labs","Vantor":"Vantor","Maxar":"Vantor","Maxar_Intelligence":"Vantor","BlackSky":"BlackSky","Satellogic":"Satellogic","Capella_Space":"Capella_Space","Capella":"Capella_Space","Umbra":"Umbra","ICEYE":"ICEYE","Spire_Global":"Spire_Global","Spire":"Spire_Global","HawkEye360":"HawkEye360","HawkEye_360":"HawkEye360","Albedo":"Albedo","Airbus_DS":"Airbus_DS","Airbus_Defence_Space":"Airbus_DS","Synspective":"Synspective","ChangGuang":"ChangGuang","Jilin_1":"ChangGuang","Spacety":"Spacety","NGA":"NGA","SDA":"SDA","Space_Development_Agency":"SDA","Rocket_Lab":"Rocket_Lab","RocketLab":"Rocket_Lab","ULA":"ULA","Blue_Origin":"Blue_Origin","Firefly":"Firefly","Sierra_Space":"Sierra_Space","Advent_International":"Advent_International","Advent":"Advent_International","Commercial_Space_Imaging":"Commercial_Space_Imaging",
 # meta child-safety opinion-shaping vehicles
 ...
 "Arbitration_ADR_System":"Arbitration_ADR_System","American_Arbitration_Association":"American_Arbitration_Association","AAA":"American_Arbitration_Association","JAMS":"JAMS","FINRA_DR":"FINRA_DR","FINRA":"FINRA","National_Arbitration_Forum":"National_Arbitration_Forum","NAF":"National_Arbitration_Forum","FMCS":"FMCS","National_Mediation_Board":"National_Mediation_Board","Federal_Arbitration_Act":"Federal_Arbitration_Act","Mass_Arbitration":"Mass_Arbitration","Keller_Postman":"Keller_Postman","Keller_Lenkner":"Keller_Postman","Institute_for_Legal_Reform":"Institute_for_Legal_Reform","CFPB":"CFPB","ICC_Arbitration":"ICC_Arbitration","LCIA":"LCIA","SIAC":"SIAC","HKIAC":"HKIAC","CIETAC":"CIETAC","New_York_Convention":"New_York_Convention","UNCITRAL":"UNCITRAL","ISDS":"ISDS","ICSID":"ICSID","Energy_Charter_Treaty":"Energy_Charter_Treaty","PCA_Arbitration":"PCA_Arbitration","CAS":"CAS","State_ADR":"State_ADR","Beth_Din":"Beth_Din","Kleros":"Kleros","Aragon_Court":"Aragon_Court","UMA_Protocol":"UMA_Protocol","UMA":"UMA_Protocol",
 ...
 "Antarctica":"Antarctica","Antarctic_Treaty":"Antarctic_Treaty","Madrid_Protocol":"Madrid_Protocol",
 # americas + sahel
 ...
 "China_EV":"China_EV","BYD":"BYD","SAIC":"SAIC","NIO":"NIO","XPeng":"XPeng","Li_Auto":"Li_Auto","Xiaomi_EV":"Xiaomi_EV","Chery":"Chery","Great_Wall_Motor":"Great_Wall_Motor","Leapmotor":"Leapmotor","CATL":"CATL","EV_Tariffs":"EV_Tariffs","AV_Robotaxi":"AV_Robotaxi","Waymo":"Waymo","Baidu_Apollo":"Baidu_Apollo",
...
NODE_META = {
 ...
 # planet labs + commercial space-imaging / EO industry (overlay) — hub is a pure sink
 "Planet_Labs":("satellite",True),"Vantor":("satellite",True),"BlackSky":("satellite",True),"Satellogic":("satellite",True),"Capella_Space":("satellite",True),"Umbra":("satellite",True),"ICEYE":("satellite",True),"Spire_Global":("satellite",True),"HawkEye360":("satellite",True),"Albedo":("satellite",True),"Airbus_DS":("satellite",True),"Synspective":("satellite",True),"ChangGuang":("satellite",True),"Spacety":("satellite",True),"NGA":("state_intel",False),"SDA":("state_intel",False),"Rocket_Lab":("space_real_economy",True),"ULA":("space_real_economy",True),"Blue_Origin":("space_real_economy",True),"Firefly":("space_real_economy",True),"Sierra_Space":("space_real_economy",True),"Advent_International":("financier",True),"Commercial_Space_Imaging":("satellite",False),
 # meta child-safety opinion-shaping vehicles (overlay)
 "American_Edge_Project":("political",False),"Meta_State_SuperPACs":("political",False),"Digital_Childhood_Alliance":("political",False),"National_PTA":("other",False),"Targeted_Victory":("political",False),"NetChoice":("political",False),"Louisiana_HB570":("political",False),
 "Julie_Inman_Grant":("person",False),
 # dialog society (thiel/hoffman private forum) — overlay; Dialog_Society is a PURE SINK
 "Dialog_Society":("other",False),"Stonebrick_LLC":("other",False),"Peter_Thiel":("person",False),"Auren_Hoffman":("person",False),"Raffi_Grinberg":("person",False),"Thiel_Foundation":("political",False),"Founders_Fund":("financier",True),"Andreessen_Horowitz":("financier",True),
 # arbitration / ADR bodies (overlay) — hub is a pure sink
 "Arbitration_ADR_System":("standards",False),"American_Arbitration_Association":("standards",True),"JAMS":("standards",True),"FINRA_DR":("regulator",False),"FINRA":("regulator",True),"National_Arbitration_Forum":("standards",False),"FMCS":("regulator",False),"National_Mediation_Board":("regulator",False),"Federal_Arbitration_Act":("standards",False),"Mass_Arbitration":("standards",False),"Keller_Postman":("standards",True),"Institute_for_Legal_Reform":("political",False),"CFPB":("regulator",False),"ICC_Arbitration":("standards",False),"LCIA":("standards",False),"SIAC":("standards",False),"HKIAC":("standards",False),"CIETAC":("standards",False),"New_York_Convention":("standards",False),"UNCITRAL":("standards",False),"ISDS":("standards",False),"ICSID":("standards",False),"Energy_Charter_Treaty":("standards",False),"PCA_Arbitration":("standards",False),"CAS":("standards",False),"State_ADR":("standards",False),"Beth_Din":("standards",False),"Kleros":("crypto_infra",True),"Aragon_Court":("crypto_infra",False),"UMA_Protocol":("crypto_infra",True),
 ...
 "Antarctica":("state",False),"Antarctic_Treaty":("state",False),"Madrid_Protocol":("state",False),
 ...
 "China_EV":("industrial",False),"BYD":("industrial",True),"SAIC":("industrial",True),"Chery":("industrial",True),"Great_Wall_Motor":("industrial",True),"CATL":("industrial",True),
 "NIO":("industrial",False),"XPeng":("industrial",False),"Li_Auto":("industrial",False),"Xiaomi_EV":("industrial",False),"Leapmotor":("industrial",False),
 "EV_Tariffs":("state",False),"AV_Robotaxi":("tech",False),"Waymo":("tech",False),"Baidu_Apollo":("tech",False),
