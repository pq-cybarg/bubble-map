...
LABELS={  # explicit overrides (sinks, SPVs, compounds)
 ...
 "American_Edge_Project":"American Edge Project (Meta dark-money 501c4)","Meta_State_SuperPACs":"Meta state super-PACs (METAC/ATEP)","Digital_Childhood_Alliance":"Digital Childhood Alliance (app-store front group)","National_PTA":"National PTA (ex-Meta sponsor)","Targeted_Victory":"Targeted Victory (GOP PR — anti-TikTok op)","NetChoice":"NetChoice (tech-industry litigation arm)",
