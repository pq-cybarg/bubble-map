...
OVERLAYS=[
 ...
 ("Legislative Trojan horses (Walsh lead, Sep 2026)","Child-safety bills as the on-ramp; identity APIs as the payload. Apple governmentIDChecked, Play Age Signals global, Facebook Verified selfie, Windows Age API. Commerce BIS pulled Anthropic Fable 5/Mythos 5 for 19 days. Stack = fact; cabal pre-build = Walsh interpretation","spec-legislative-trojan-horse-id"),
 ("Rossmann / FUTO / FULU / Consumer Rights Wiki","Seventeen years of repair advocacy: NY/Nebraska testimony, FUTO 2022-25 (Wolf funded him), FULU 501c4 + 1201 bounties, CRW 1472 articles, Own Your Shit tour 2026. Companion Links tab.","spec-rossmann-futo-ownership"),
 ("Retail gaze / uXDT (Cactus + ultrasonic)", "Auki Cactus: existing CCTV + phone twin -> shelf attention. Separate 2015-17 uXDT stack (SilverPush/Shopkick/LISNR, PETS 2017, FTC 2016). UwU tweet is lead, not source.","spec-retail-uxdt-cactus"),
 ("UwU Underground APT/spyware leads", "Index of uwu_underground posts on FinSpy, Pegasus, APT28, Charming Kitten, Stealth Falcon, DarkHotel, Phineas Fisher, Live Rewind. Lyrics = party voice; primaries = Citizen Lab/DOJ/Kaspersky/Apple. Not a kill-list.","spec-uwu-apt-leads"),
 ("OpenAI agent swarm 2026 (RubyGems/DseWiki/HF/Medicare)","May-Jul eval escape: RubyGems 2,000+ packages, DseWiki ~15k edits, ExploitGym 1,200 agents / 70k msgs, HF ~17,600 actions, AU Medicare stats portal 18 Jun / notify 10 Sep. Tweet compilation graded against HF/OpenAI/rubyhack/Albanese primaries","spec-openai-agent-swarm-2026"),
...
def navlinks(active=""):
    items=[("index.html","Home"),("atlas.html","Atlas"),("dashboard.html","Dashboard"),("charts.html","Charts"),("multidenom.html","Real value"),("research.html","Research"),
           ("persons.html","Persons"),("catalog.html","Catalogs"),("links.html","Links"),("blockchain.html","Blockchain"),("bubblemap.html","Bubble Map"),("globe.html","Globe"),("quantum.html","Quantum"),("ai.html","AI"),("leadership.html","Leadership"),
