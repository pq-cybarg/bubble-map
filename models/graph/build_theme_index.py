...
RULES=[
 ...
 ("control",    ["digitalid","digital-id","surveillance","worldcoin","age-verif","age-assurance","cbdc","biometric","eidas","identity","right-to-repair","parts-pairing","farm-equipment","seed-ip","-corn","mcdonalds-kytch","3dprinting","ownership","repair","child-safety","child safety","chatbot","meta-ai","red-team","minors","trojan-horse","age-signals","declared-age","chat-control","kill-switch"]),
