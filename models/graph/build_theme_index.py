...
RULES=[
 ...
 ("defense",    ["defense","defence","geopolitic","taiwan","russia","iran","-war","arctic","contested-resource","military","drone","corridor","belt and road","string of pearls","opec","alignment matrix","bloc member"]),
